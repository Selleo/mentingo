...
- After product or feature behavior changes, run `.agents/skills/mentingo-feature-overview/SKILL.md` and save/update the business spec in `docs/specs/<feature-slug>-business-spec.md`.
