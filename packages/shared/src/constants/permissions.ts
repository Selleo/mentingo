...
export const PERMISSIONS = {
  ...
  ACHIEVEMENTS_CREATE: "achievements.create",
  ACHIEVEMENTS_UPDATE: "achievements.update",
  ACHIEVEMENTS_DELETE: "achievements.delete",
  ACHIEVEMENTS_VIEW_HIDDEN: "achievements.view_hidden",
  ACHIEVEMENTS_MANAGE_PARAMS: "achievements.manage_params",
} as const;
...
export const SYSTEM_ROLE_PERMISSIONS: Record<string, PermissionKey[]> = {
  [SYSTEM_ROLE_SLUGS.STUDENT]: [
    ...
    PERMISSIONS.ACHIEVEMENTS_VIEW_HIDDEN,
  ],
  ...
  [SYSTEM_ROLE_SLUGS.ADMIN]: [
    ...
    PERMISSIONS.ACHIEVEMENTS_DELETE,
    PERMISSIONS.ACHIEVEMENTS_MANAGE_PARAMS,
  ],
};
