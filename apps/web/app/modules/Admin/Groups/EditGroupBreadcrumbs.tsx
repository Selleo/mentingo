...
type EditeGroupPageBreadcrumbsProps = {
  id: string;
};

export const EditeGroupPageBreadcrumbs = ({ id }: EditeGroupPageBreadcrumbsProps) => {
    ...
    <div className="mb-4 bg-primary-50">
      <BreadcrumbList>
        ...
        <BreadcrumbItem className="text-neutral-950">
          <BreadcrumbLink href={`/admin/groups/${id}`}>
            {t("adminGroupsView.breadcrumbs.editGroup")}
          </BreadcrumbLink>
        </BreadcrumbItem>
      </BreadcrumbList>
    </div>
