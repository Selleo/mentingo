        ...
        render={({ field }) => (
          <FormItem className="mb-4 flex-1">
                ...
                >
                  <ul className="flex list-inside list-disc flex-col gap-2">
                    {Object.entries({
                      ...
                      Teacher: "adminCourseView.curriculum.lesson.other.aiTeacherTypeTooltip",
                      Roleplay: "adminCourseView.curriculum.lesson.other.aiRoleplayTypeTooltip",
            ...
            <Select onValueChange={field.onChange} value={field.value}>
              ...
              <SelectContent>
                {Object.values(AI_MENTOR_TYPE).map((item) => (
