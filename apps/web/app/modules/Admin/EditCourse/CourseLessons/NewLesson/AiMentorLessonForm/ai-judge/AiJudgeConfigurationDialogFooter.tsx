...
type AiJudgeConfigurationDialogFooterProps = {
...
export const AiJudgeConfigurationDialogFooter = ({
  canEditStructure,
  canImprove,
  canValidate,
  isAiBusy,
  ...
  onImprove,
  onValidate,
}: AiJudgeConfigurationDialogFooterProps) => {
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              {t("adminCourseView.curriculum.lesson.aiJudge.aiAssistance")}
          ...
          <DropdownMenuContent align="start" className="w-64 rounded-lg bg-white p-1.5">
            {canImprove && (
              ...
              >
                ...
                <span>{t("adminCourseView.curriculum.lesson.aiJudge.improveWithAi")}</span>
              </DropdownMenuItem>
            )}
            {canValidate && (
              <DropdownMenuItem
              ...
              >
                ...
                <span>{t("adminCourseView.curriculum.lesson.aiJudge.checkQualityWithAi")}</span>
              </DropdownMenuItem>
            )}
          </DropdownMenuContent>
        </DropdownMenu>
