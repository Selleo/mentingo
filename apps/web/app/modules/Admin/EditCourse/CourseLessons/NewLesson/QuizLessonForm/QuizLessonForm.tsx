      ...
      const getOptionsForQuestionType = (type: QuestionType): QuestionOption[] => {
        ...
        if (type === QuestionType.SCALE_1_5) {
          return [
            ...
            { sortableId: crypto.randomUUID(), optionText: "", isCorrect: false, displayOrder: 3 },
            { sortableId: crypto.randomUUID(), optionText: "", isCorrect: false, displayOrder: 4 },
            { sortableId: crypto.randomUUID(), optionText: "", isCorrect: false, displayOrder: 5 },
          ];
        }
