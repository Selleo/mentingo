...
import type { LiveTrainingCalendarEventDetails } from "../calendarEventDetails.types";

type CalendarLiveTrainingEventDetailsDialogProps = {
  open: boolean;
  eventDetails: LiveTrainingCalendarEventDetails;
  onOpenChange: (open: boolean) => void;
};

export function CalendarLiveTrainingEventDetailsDialog({
  open,
  eventDetails,
  onOpenChange,
}: CalendarLiveTrainingEventDetailsDialogProps) {
            ...
            <CalendarEventMetaRow
              ...
              value={
                <span className="flex flex-wrap items-center gap-2">
                  <span>{t(`calendarView.details.deliveryType.${liveTraining.deliveryType}`)}</span>
                </span>
              }
            />
