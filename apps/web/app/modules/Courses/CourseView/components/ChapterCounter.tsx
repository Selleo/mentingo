  ...
  return (
    <div
      className={cn(
        ...
        {
          "after:hidden": isLastChapter,
          "after:bg-primary-200":
            !isLastChapter && (isPreviewMode || (!isChapterStarted && !isChapterCompleted)),
          "after:bg-secondary-200": !isLastChapter && !isPreviewMode && isChapterStarted,
          "after:bg-success-200": !isLastChapter && !isPreviewMode && isChapterCompleted,
        },
      )}
    >
      <div
        className={cn("relative aspect-square size-10 rounded-full", {
          "bg-primary-50": isPreviewMode || (!isChapterStarted && !isChapterCompleted),
