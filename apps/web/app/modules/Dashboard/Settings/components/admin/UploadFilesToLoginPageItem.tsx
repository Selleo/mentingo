...
export const UploadFilesToLoginPageItem = ({
  ...
  return (
    <div
      className="flex items-center justify-between gap-4 rounded-lg border bg-white px-4 py-3 shadow-sm transition-colors hover:border-primary-200 hover:bg-primary-50/40"
      data-testid={SETTINGS_PAGE_HANDLES.loginPageFileItem(resource.name)}
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <button
            ...
            data-testid={SETTINGS_PAGE_HANDLES.loginPageFilePreview(resource.name)}
          >
            {resource.name}
          </button>
        </div>
      ...
      <Button
        ...
        data-testid={SETTINGS_PAGE_HANDLES.loginPageFileDelete(resource.name)}
      >
