...
setup("authenticate", async ({ browser }) => {
  ...
  await studentAuthFixture.login(getTenantEmail("student@example.com"), "password");
  ...
  await adminAuthFixture.login(getTenantEmail("admin@example.com"), "password");
  ...
  await contentCreatorAuthFixture.login(getTenantEmail("contentcreator@example.com"), "password");
