...
export const COURSES_PAGE_HANDLES = {
  ...
  BULK_EDIT_TRIGGER: "courses-page-bulk-edit-trigger",
  rowActionsTrigger: (courseId: string) => `courses-page-row-actions-trigger-${courseId}`,
  BULK_EDIT_CATEGORY_ACTION: "courses-page-bulk-edit-category-action",
  BULK_EDIT_STATUS_ACTION: "courses-page-bulk-edit-status-action",
  BULK_EDIT_DELETE_ACTION: "courses-page-bulk-edit-delete-action",
  DUPLICATE_ACTION: "courses-page-duplicate-action",
  CATEGORY_DIALOG: "courses-page-category-dialog",
  CATEGORY_SELECT: "courses-page-category-select",
  categoryOption: (categoryId: string) => `courses-page-category-option-${categoryId}`,
  CATEGORY_DIALOG_CANCEL_BUTTON: "courses-page-category-dialog-cancel-button",
  CATEGORY_DIALOG_CONFIRM_BUTTON: "courses-page-category-dialog-confirm-button",
  ...
  STATUS_DIALOG: "courses-page-status-dialog",
  statusOption: (status: CourseStatus) => `courses-page-status-option-${status}`,
  STATUS_DIALOG_CANCEL_BUTTON: "courses-page-status-dialog-cancel-button",
  STATUS_DIALOG_CONFIRM_BUTTON: "courses-page-status-dialog-confirm-button",
