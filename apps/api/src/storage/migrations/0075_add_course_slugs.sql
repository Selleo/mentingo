...
CREATE TABLE IF NOT EXISTS "course_slugs" (
	...
	"lang" text NOT NULL,
	CONSTRAINT "course_slugs_course_short_id_courses_short_id_fk" FOREIGN KEY ("course_short_id") REFERENCES "public"."courses"("short_id") ON DELETE cascade ON UPDATE cascade
);
--> statement-breakpoint
