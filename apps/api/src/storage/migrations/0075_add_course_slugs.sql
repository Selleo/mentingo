...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "course_slug_course_short_id_lang_slug_unique_idx" ON "course_slugs" USING btree ("course_short_id","lang","slug");--> statement-breakpoint
