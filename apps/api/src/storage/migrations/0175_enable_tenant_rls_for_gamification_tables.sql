...
BEGIN
  FOR r IN
    ...
    WHERE column_name = 'tenant_id'
      ...
      AND table_name IN ('achievement_levels', 'achievements', 'challenges', 'processed_source_events', 'user_achievement_levels', 'user_challenge_progress', 'user_progress', 'xp_transactions')
  LOOP
