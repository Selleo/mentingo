          ...
          },
          {
            ...
            questions: [
              ...
              },
              {
                ...
                options: [
                  { optionText: "Cypress", isCorrect: true, language: "en" },
                  { optionText: "Jest", isCorrect: false, language: "en" },
                ],
                language: "en",
              },
              {
                ...
                options: [
                  {
                    optionText: "Simulates real user interactions",
                    isCorrect: true,
                    language: "en",
                  },
                  { optionText: "Focuses only on unit tests", isCorrect: false, language: "en" },
                  {
                    optionText: "Tests entire application workflow",
                    isCorrect: true,
                    language: "en",
                  },
                  { optionText: "Validates data integrity", isCorrect: false, language: "en" },
                ],
                language: "en",
              },
              {
                ...
                options: [
                  { optionText: "True", isCorrect: false, language: "en" },
                  { optionText: "False", isCorrect: true, language: "en" },
                ],
                language: "en",
              },
              {
                ...
                options: [
                  { optionText: "Workflow A", isCorrect: false, language: "en" },
                  { optionText: "Workflow B", isCorrect: true, language: "en" },
                  { optionText: "Workflow C", isCorrect: false, language: "en" },
                  { optionText: "Workflow B", isCorrect: false, language: "en" },
                ],
                language: "en",
              },
              {
                ...
                options: [
                  { optionText: "Cypress", isCorrect: true, language: "en" },
                  { optionText: "Jest", isCorrect: false, language: "en" },
                  { optionText: "Playwright", isCorrect: true, language: "en" },
                  { optionText: "Vitest", isCorrect: false, language: "en" },
                ],
                language: "en",
              },
              {
