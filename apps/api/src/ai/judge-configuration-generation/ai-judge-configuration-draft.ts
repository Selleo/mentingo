import { validateAiJudgeConfigurationContent } from "../../lesson/ai-judge-configuration/ai-judge-configuration-content-validator";
import { AI_JUDGE_CONTENT_VALIDATION_CODE } from "../../lesson/ai-judge-configuration/ai-judge-configuration-content-validator.types";
...
import type { AiJudgeContentValidationIssue } from "../../lesson/ai-judge-configuration/ai-judge-configuration-content-validator.types";
  ...
  return [
    {
      ...
      message: `${invalidReference} is not the next available ${isCriterion ? "criterion" : "blocking-error"} reference.`,
