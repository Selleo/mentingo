...
** In other system level prompts you will get data. That is your RAG system. If you happen to retrieve data and then speak about it, please refer to it as your sources.
