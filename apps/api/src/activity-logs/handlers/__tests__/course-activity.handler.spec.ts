...
describe("CourseActivityHandler", () => {
  it("records one aggregate activity log for bulk course category updates", async () => {
    ...
    const previousCategoryId = "00000000-0000-0000-0000-000000000201";
    const categoryId = "00000000-0000-0000-0000-000000000202";
    const updates = [
      {
    ...
    expect(recordActivity).toHaveBeenCalledWith({
      ...
      before: {
        courseCategories: JSON.stringify([
          { courseId: "00000000-0000-0000-0000-000000000101", categoryId: previousCategoryId },
          { courseId: "00000000-0000-0000-0000-000000000102", categoryId: previousCategoryId },
        ]),
      },
      after: {
        categoryId,
        courseCategories: JSON.stringify([
          { courseId: "00000000-0000-0000-0000-000000000101", categoryId },
          { courseId: "00000000-0000-0000-0000-000000000102", categoryId },
        ]),
      },
      context: {
        categoryId,
  ...
  it("skips activity logging when no course categories changed", async () => {
    const recordActivity = jest.fn();
    const runWithTenant = jest.fn((_: string, callback: () => Promise<void>) => callback());
    const module = await Test.createTestingModule({
      providers: [
