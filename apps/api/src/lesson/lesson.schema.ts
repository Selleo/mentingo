...
const lessonQuizSchema = Type.Object({
  ...
  thresholdScore: Type.Optional(Type.Number()),
  attemptsLimit: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  quizCooldown: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  questions: Type.Optional(Type.Array(adminQuestionSchema)),
});
...
export const lessonShowSchema = Type.Object({
  ...
  isThereStudentAnswer: Type.Union([Type.Boolean(), Type.Null()]),
