...
- Frontend unit/source evidence covers profile certificate cards, previews, downloads, language toggles, LinkedIn sharing controls, certificate theme behavior, the modern course certificate stat card and modal, disabled settings, immediate issuance updates, signature controls, color saving on picker close, validity-impact confirmation, and reset dialogs.
